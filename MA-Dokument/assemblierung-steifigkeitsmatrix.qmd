...
beschrieben werden, mit D ensprechend @eq-plattensteifigkeit.
...
&w,_y_k = -sin(\gamma_k) \cdot w,_n_k - cos(\gamma_k) \cdot w,_s_k \qquad \qquad \qquad \text{mit}\gamma_k = \gamma_{ij} \\
\end{align}
$$
...
Die Elementsteifigkeitsmatrizen entspricht der in @eq-elementsteifigkeitsmatrix.
