# DGL einer Platte nach Kirchhoff{#sec-dgl-einer-platte-nach-der-kirchhoffschen-plattentheorie}
...
Die Gesetztmäßigkeiten nach @eq-black-scholes-01, @eq-black-scholes-06 und @eq-black-scholes-07 werden in der Literatur auch als Verschiebungsfeld nach der Kirchhoffschen Plattentheorie bezeichnet.

![Verdrehung und Verschiebung eines Punktes nach Kirchhoff](00-pics/Verschiebung.png){width=100%}
...
oder auch Gleitung, beschreibt eine Winkeländerung. Konsistent mit den in @eq-black-scholes-06 und @eq-black-scholes-07 getroffenen Annahmen, als Folge des Ebenbleibens der Querschnitte, ergeben sich die Schubverzerrungen
$$ 
\begin{align} 
