...
Für die numerische Lösung des Problems wird zunächst die Gleichung des abstrakte diskrete Variarionsproblem durch $N$ Gleichungen mit $w_h$ als Unbekannte ersetzt. Die Linearkombination

$$
\delta w_h = \sum_{i = 1}^N \varphi_i \cdot \delta \hat{w}_i
$$

eingesetzen in @eq-abstraktes-diskretes-variationsproblem ergibt 
...
Entsprechend den Rechenoperationen für Funktionale (@sec-funktionale) ergibt sich 
