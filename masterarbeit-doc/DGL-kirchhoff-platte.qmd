...
Die zugrunde liegende Theorie wurde von Gustav Kirchhoff im Jahr 1850 zum ersten Mal formuliert [QUELLE]. Entsprechend der Annahmen von Bernoulli in Bezug auf einen elastischen Stab, geht Kirchhoff von folgenden zwei grundlegenden kinematischen Annahmen aus:
...
Die Momente resultierend aus den Normalspannungen und die Drillmomente resulierend aus den ebenen Schubspannungen sind in @fig-biegemomente-platte und @fig-drillmomente-platte dargestellt.
