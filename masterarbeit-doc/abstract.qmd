...
Ziel dieser Arbeit ist die, sonst primär in englischer Sprache verfassten theoretischen Grundlagen der FEM in deutscher Sprache aufzuarbeiten. Teil dessen ist die Herleitung mechanischer Zusammenhänge sowie die Erläuterung mathematischer Verfahrung zu Konstruktion sogenannter $C^1$-stetiger Basisfunktionen. Die Differentialgleichung der Kirchhoff-Platte stellt hierbei die Basis für die numerischen Berechnungen dar. 
