...
include("../src/setup.jl")
WGLMakie.activate!
plotw(mQuadBFS, w;conforming = true,title="Verformung")
```
...
figBFSmx = plotr(mQuadBFS, :mx, "Biegemoment mx", (-17, 17),nodal = false, a3d=true)
save("Beispiel-01-BFS-mx.png",figBFSmx)
```


```{julia}
figBFSmy= plotr(mQuadBFS, :my, "Biegemoment my", (-17, 17),nodal = false, a3d=true)
```

```{julia}
figBFSmxy= plotr(mQuadBFS, :mxy, "Biegemoment mxy", (-4, 4),nodal = false, a3d=true)
```
