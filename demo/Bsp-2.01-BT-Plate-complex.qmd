...
using Makie
GLMakie.activate!()
mesh02 = Mesh("gmesh/plate-Bsp-03.msh")
# fixierte Knoten
...
K,r = assembleKr(mesh02, nf)
display(K)
applyDirichletBCs!(mesh02.groups[:fixed0], K, r, bcs)
applyDirichletBCs!([4,9,11], K, r, bcs)
```
...
```{julia}
figB02mx = plotrBTP(mesh02, :mx, "Biegemoment mx", (-17000, 17000),nodal = false, a3d=true)
```
