...
Plane Surface(1) = {1, 2};
//+
Physical Point("column", 14) = {5, 10, 12};
Physical Curve("fixed", 15) = {8, 1, 2, 12, 3, 4, 5, 13};
Physical Curve("free", 16) = {7, 6, 9, 11, 10};
Physical Surface("plate", 17) = {1};
//+
Recombine Surface {1};
MeshSize{:} = 0.25;
Mesh 2;

Save "plate-Bsp-03.2.msh";
