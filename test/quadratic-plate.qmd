...
```{julia}
bc = [true,true,true]
dofs = [1,2,3,4,6,7,8,9]

cnt = 1
nff = sum(bc)        # summe (true = 1; false = 0)
nf = length(bc)      # länge vektor 
idxs = zeros(Int, nff * lengtdofsh()) # Anzahl der Freiheitsgrade für die Randknoten
